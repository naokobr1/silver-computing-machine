...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                <label for="change-form" class="form-label">1.Please select career path you have decided on.</label>
                <select class="form-select" name="change_form" id="change-form">
                    <option value="" hidden>Future Path</option>
                    <option value="1" >Employement</option>
                    <option value="2" >Higher Education</option>
                </select>
            </div>
            <button type="submit" name="btn_check">Change Form</button>
        </form>

        <?php
        if (isset($_POST['btn_check'])) {
            $selected = $_POST['change_form'];
            if ($selected == 1) {
        ?>
                <form action="check-cd-emp.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="prefecture" id="prefecture">
            ...
            <?php
                ...
                ?>
                <form action="check-cd-edu.php" method="post">
                    <!--1. Select Future path-->
                    <div class="mb-3">
                        <label for="fp-cat-id" class="form-label">1.Please select career path you have decided on.</label>
                        <select class="form-select" name="fp_cat_id" id="fp-cat-id">
                ...
                <!--7. Further Education-->
                    <div class="mb-3">
                        <label for="higher-edu" class="form-label">7.Please enter your higher education.</label>
                        <input type="text" name="higher_edu" id="higher-edu" class="form-control">
